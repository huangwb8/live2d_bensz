...
function loadWidget(config) {
	...
	(function registerEventListener() {
		...
		document.querySelector("#waifu-tool .fa-info-circle").addEventListener("click", () => {
			open("https://github.com/huangwb8");
		});
	...
	(function initModel() {
		...
		$("#live2d").mousedown(function(e) {
			if(e.which==3){
				showMessage("<div style=\"text-align:center\">秘密通道<br/><a href=\"javascript:aplayer_panel_toggle();\">音乐播放器</a><br/><a href=\"https://blognas.hwb0307.com" target=\"_blank\">WordPress</a><br/><a href=\"https://crowya.com\" target=\"_blank\">鸦鸦博客</a></div>",4000,10);
				}
			}
		);
