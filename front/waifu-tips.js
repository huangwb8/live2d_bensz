 ...
 * 
 * Beta versions:
 * live2d_bensz v3.0.8 增加按扭。详见：https://crowya.com/1088
 *
 * Stable versions: 
		...
		fetch(waifuPath)
			...
			.then(result => {
				...
				$("#live2d").mousedown(function(e) {
				        if(e.which==3){
				        showMessage("<div style=\"text-align:center\">秘密通道<br/><a href=\"javascript:aplayer_panel_toggle();\">音乐播放器</a><br/><a href=\"https://crowya.com/yayawplogin\" target=\"_blank\">WordPress</a><br/><a href=\"http://139.224.16.2:1999/yayabt/\" target=\"_blank\">宝塔面板</a><br/><a href=\"https://homenew.console.aliyun.com/\" target=\"_blank\">阿里云</a></div>",4000,10);
						}
				});
