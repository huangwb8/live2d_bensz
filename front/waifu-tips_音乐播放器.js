 ...
 * modified by crowya https://github.com/crowya
 */
		...
		fetch(waifuPath)
			...
			.then(result => {
				...
				$("#live2d").mousedown(function(e) {
				        if(e.which==3){
				        showMessage("<div style=\"text-align:center\">秘密通道<br/><a href=\"javascript:aplayer_panel_toggle();\">音乐播放器</a><br/><a href=\"https://crowdrink.com/yayawplogin\" target=\"_blank\">WordPress</a><br/><a href=\"http://101.133.211.86:1999/yayabt/\" target=\"_blank\">宝塔面板</a></div>",4000,10);
						}
				});
